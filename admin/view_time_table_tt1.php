                                ...
                                <table class="table table-responsive table-bordered content"></center>
                                    ...
                                    if(isset($_POST['select_department']) && isset($_POST['select_semester'])&& isset($_POST['select_year'])) {
                                        ...
                                        for($i=0;$i<count($days);$i++){
                                            ...
                                            $ret_arr = pg_fetch_all($ret);  //MONDAY TUESDAY ...
                                            ...
                                            if(pg_num_rows($ret) == 0) {
                                                ...
                                                $position = $ret_arr[$counter]['timeslot_id'];
                                                $entries = array_count_values(array_column($ret_arr,'timeslot_id'));
                                                $subject = "";
                                                for($j=0;$j<count($times);$j++) {
                                                    $subject = "";
                                                    if ($j < $position) {
                                                        ...
                                                        $count = 0;
                                                        while($count++ < $entries[$position]) {
                                                            $sub = $ret_arr[$counter]['sname'];
                                                            $teach = $ret_arr[$counter]['name'];
                                                            $stype = $ret_arr[$counter]['stype'];
                                                            $class = $ret_arr[$counter]['cno'];
                                                            $subject .= $sub ."</br>". $teach ."</br>" .$class ."</br>-----</br>";
                                                            $counter++;
                                                        }

                                                        echo "<td style=\"text-align:center\" scope=\"row\">$subject</br></td>";
