...
$cq="select cno from course where cname='$cname'";
$sr=pg_query($db,$sq);
$tr=pg_query($db,$tq);
$dr=pg_query($db,$dq);
$cr=pg_query($db,$cq);
...
if($stype == 'PRACTICAL') {
    if($timeslot =='7:30-11:00') {
        ...
        if(!$tbq){
            ...
            $timeslot_id = 0;
            $sql = "insert into allot values ($did[0],'$sem',$sid[0],$tid[0],$cid[0],'7:30-8:20','$day',$timeslot_id)";
            $ret = pg_query($db, $sql);
            $timeslot_id++;
            $sql = "insert into allot values ($did[0],'$sem',$sid[0],$tid[0],$cid[0],'8:20-9:10','$day',$timeslot_id)";
            $ret = pg_query($db, $sql);
            $timeslot_id++;
            $sql = "insert into allot values ($did[0],'$sem',$sid[0],$tid[0],$cid[0],'9:10-10:00','$day',$timeslot_id)";
            $ret = pg_query($db, $sql);
            $timeslot_id++;
            $sql = "insert into allot values ($did[0],'$sem',$sid[0],$tid[0],$cid[0],'10:10-11:00','$day',$timeslot_id)";
            $ret = pg_query($db, $sql);
        }
        else {
            header("Location:gen-time-table1.php");
        }
        ...
        if(!$tbq){
            ...
            $timeslot_id = 4;
            $sql = "insert into allot values ($did[0],'$sem',$sid[0],$tid[0],$cid[0],'11:00-11:50','$day',$timeslot_id)";
            $ret = pg_query($db, $sql);
            $timeslot_id++;
            $sql = "insert into allot values ($did[0],'$sem',$sid[0],$tid[0],$cid[0],'11:50-12:40','$day',$timeslot_id)";
            $ret = pg_query($db, $sql);
            $timeslot_id++;
            $sql = "insert into allot values ($did[0],'$sem',$sid[0],$tid[0],$cid[0],'12:40-1:30','$day',$timeslot_id)";
            $ret = pg_query($db, $sql);
        }
        else {
            header("Location:gen-time-table1.php");
        ...
        $timeslot_id=7;
        $sql = "insert into allot values ($did[0],'$sem',$sid[0],$tid[0],$cid[0],'2:40-3:30','$day',$timeslot_id)";
        $ret = pg_query($db, $sql);
        $timeslot_id++;
        $sql = "insert into allot values ($did[0],'$sem',$sid[0],$tid[0],$cid[0],'3:30-4:20','$day',$timeslot_id)";
        $ret = pg_query($db, $sql);
        $timeslot_id++;
        $sql = "insert into allot values ($did[0],'$sem',$sid[0],$tid[0],$cid[0],'4:20-5:10','$day',$timeslot_id)";
        $ret = pg_query($db, $sql);
    ...
    $sql = "insert into allot values ($did[0],'$sem',$sid[0],$tid[0],$cid[0],'$timeslot','$day',$timeslot_id)";
