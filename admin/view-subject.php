                    ...
                    <div class="card">
                        <div class="card-body">
                            <table id="basic-datatable" class="table dt-responsive nowrap table-bordered ">
                                <thead>
                                <tr>
                                    <th style=\"text-align:center\" scope="col">Subject code</th>
                                    <th style=\"text-align:center\" scope="col">Subject Name</th>
                                    ...
                                    <th style=\"text-align:center\" scope="col">Subject Type</th>
...
/*
                        ...
                        <td style=\"text-align:center\">  {$id2[0]}</td>
